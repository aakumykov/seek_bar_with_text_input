...
class SeekBarWithTextInput @JvmOverloads constructor(
    ...
    private val attribHideTextInput = initialAttributes.getBoolean(R.styleable.SeekBarWithTextInput_hideTextInput, DEFAULT_HIDE_TEXT_INPUT)
    ...
    companion object {
        ...
        const val DEFAULT_HIDE_TEXT_INPUT = false
    }
}